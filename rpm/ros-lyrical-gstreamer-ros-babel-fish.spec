...
%global pkg_name gstreamer_ros_babel_fish
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-gstreamer-ros-babel-fish
Version:        1.26.40
Release:        3%{?dist}
...
%description
GStreamer elements for bidirectional ROS 2 image streaming
...
%changelog
* Wed Apr 29 2026 Stefan Fabian <gstreamer_ros_babel_fish@stefanfabian.com> - 1.26.40-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Stefan Fabian <gstreamer_ros_babel_fish@stefanfabian.com> - 1.26.40-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Stefan Fabian <gstreamer_ros_babel_fish@stefanfabian.com> - 1.26.40-1
- Autogenerated by Bloom
